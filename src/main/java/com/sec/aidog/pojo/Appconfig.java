...
public class Appconfig {
    ...
    public Appconfig(Integer id, String appId, Integer dosingcycle, Integer areacycle, Date updatetime, Integer dosingtotal, Date firstdosingTime, Date enddosingTime) {
        this.id = id;
        this.appId = appId;
