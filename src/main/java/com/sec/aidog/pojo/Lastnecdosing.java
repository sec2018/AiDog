...
public class Lastnecdosing {
    ...
    public Lastnecdosing(Integer id, String necId, Date firstdosingTime, Date lastdosingTime, Date nextdosingTime, Date enddosingTime, Integer leftNum, String dosingMethod, String necStatus, String pillCode, String power, String temperature, Date realtime, String lng, String lat, String districtcode, Integer positioncycle, Integer dosingcycle, Date errTime, Integer errNum) {
        this.id = id;
        this.necId = necId;
