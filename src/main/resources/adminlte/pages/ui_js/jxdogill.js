...
$(function () {
    ...
    $("#a_illmodify").click(function () {
        var id = $('#illid').html();
        //修改录入信息
        var clicktype = "dogillmodify";
        var mchecknum = $("#modalinput_bpersonnum").val();
        var myangnum = $("#modalinput_bpersonillnum").val();
        var myanglv = $("#modalinput_checklv").val();
        var mcheckyear = $("#modalinput_pchechyear").val();

        var illsenddata = {};
        illsenddata.clicktype = clicktype;
        illsenddata.id = id;
        illsenddata.mchecknum = mchecknum;
        illsenddata.myangnum = myangnum;
        illsenddata.myanglv = myanglv;
        illsenddata.mcheckyear = mcheckyear;
                    ...
                    success: function (data) {
                        if (data.data.data == null) {
                            ...
                            for(var i = 0;i<data.data.data.length;i++){
                                ...
                                data.data.data[i].mchecknum = data.data.data[i].mchecknum || 0;
                                data.data.data[i].myangnum = data.data.data[i].myangnum || 0;
                                data.data.data[i].myanglv = data.data.data[i].myanglv || 0;
                                data.data.data[i].mcheckyear =  data.data.data[i].mcheckyear || "--";
                ...
                if (data.data.data == null) {
                    ...
                    dt = $('#datatable').dataTable({
                        ...
                        "columns": [
                            ...
                            { "data": "mchecknum","width":"85px"},
                            { "data": "myangnum","width":"75px" },
                            { "data": "myanglv","width":"70px" },
                            { "data": "mcheckyear" ,"width":"60px"},
...
function modifyIll(obj) {
    ...
    $("#modalinput_bpersonnum").val(obj.mchecknum);
    $("#modalinput_bpersonillnum").val(obj.myangnum);
    $("#modalinput_checklv").val(obj.myanglv);
    $("#modalinput_pchechyear").val(obj.mcheckyear);
