            ...
            success: function (data) {
                if (data.data.data == null) {
                    ...
                    for(var i = 0;i<data.data.data.length;i++){
                        data.data.data[i].appvedionum = 0;
                        data.data.data[i].appfactvedionum = 0;
                    ...
                    var dt = $('#datatable').DataTable({
                        ...
                        "columns": [
                            ...
                            { "data": "appvedionum","width":"130px"  },
                            { "data": "appfactvedionum" ,"width":"90px"},
                            { "data": "appbadnumper","width":"130px"  }
                        ],
                        buttons: [
                            'pageLength',
                            {
