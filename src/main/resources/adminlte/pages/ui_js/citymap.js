        ...
        function (ec) {
            ...
            mapGeoData.params[cityEchartsAreaName] = {
                getGeoJson: (function (c) {
                    ...
                    return function (callback) {
                        $.getJSON('../ui_js/chart/geometryCouties/' + geoJsonName + '.json', callback);
                    }
                })(cityEchartsAreaName)
            }
            ...
            myChart.on("click", function (param) {
                ...
                if (param.seriesName != '' && param.name == name_selected) {
                    window.location.href = "../UI/countymap.html?province=" + escape(provinceGov) + "&city=" + escape(cityGov) + "&county=" +escape(param.name);
