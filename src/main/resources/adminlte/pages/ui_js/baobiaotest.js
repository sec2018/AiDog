...
var contextPath = "http://180.153.142.168:8088/pmt"

$(function () {
    // var mes = new Array();
    // $.ajax({
    //     url: contextPath+'/findAllPmtMachineArticleSetNew',
    //     type: 'POST',
    //     dataType: 'json',
    //     async:false,
    ...
    //
    // $.ajax({
    //     url: contextPath+'/getDoffstatistics',
    //     type: 'POST',
    //     async : false,
    //     data: { "id": mes[0].machineId,"time":$("#doffformselect").val(),"time2":$("#doffformselect2").val()},
    ...
    $.getJSON ("/aidog/adminlte/pages/ui_js/data.json", function (data1)
    {
        //一个data数组
        if(data1.length>0){
            var num2=data1[0].detail.length;
